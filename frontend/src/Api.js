...
const Api = {
    ...
    vincularServicoAgendamento: async ({idPontoAtendimentoUsuario, idSocioVeiculoAgenda, idServico, numeroOS, descricao, video, fotos, foto1, foto2, foto3}) => {
        return await axios.post(`${API_BASE}/agendamentos/vincular-servico`, {idPontoAtendimentoUsuario, idSocioVeiculoAgenda, idServico, numeroOS, descricao, video, fotos, foto1, foto2, foto3}, Environment.HEADERS).then(async (response) => {
            return await response;
        }).catch(err => {
            return err;
        });
    ...
    concluirAgendamento: async ({idSocioVeiculoAgenda, idPontoAtendimentoUsuario, idSocio, responsavel, observacao, km}) => {
        return await axios.post(`${API_BASE}/agendamentos/concluir`, {idSocioVeiculoAgenda, idPontoAtendimentoUsuario, idSocio, responsavel, observacao, km}, Environment.HEADERS).then(async (response) => {
            return await response;
        }).catch(err => {
            return err;
        });
