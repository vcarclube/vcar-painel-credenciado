                          ...
                          {servicos.map(servico => (
                            <div key={servico.id} className="execucao-os__table-row">
                              ...
                              <div className="execucao-os__table-cell execucao-os__table-cell--status-icon">
                                <div className="execucao-os__status-icon-wrapper" tabIndex={0} role="button" aria-label={servico?.StatusAprovacao === 'A' ? 'Aprovado' : servico?.StatusAprovacao === 'R' ? 'Reprovado' : 'Pendente de aprovação'} title={servico?.StatusAprovacao === 'A' ? 'Aprovado' : servico?.StatusAprovacao === 'R' ? 'Reprovado' : 'Pendente de aprovação'}>
